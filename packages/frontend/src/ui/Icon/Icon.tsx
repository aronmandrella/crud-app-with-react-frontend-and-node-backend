...
/*
  NOTE:
  I didn't want to install FontAwesome for two icons. I used is as a random custom svg.
...
const TrashIcon: React.VFC<IIconProps> = React.memo((svgProps) => {
  /*
  ...
  */
  return (
    <svg height="1em" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" {...svgProps}>
      <path
        fill="currentColor"
...
const PencilIcon: React.VFC<IIconProps> = React.memo((svgProps) => {
  /*
    Font Awesome Pro 6.1.1 by @fontawesome https://fontawesome.com
    License - https://fontawesome.com/license (Commercial License)
    Copyright 2022 Fonticons, Inc.
